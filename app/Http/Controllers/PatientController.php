                    ...
                    ->addColumn('option', function($row){
                        $option = '
                            ...
                            <a href="patient/'.$row->id.'/edit">
                                <button type="button" class="btn btn-primary btn-sm btn-rounded waves-effect waves-light mb-2 mb-md-0" title="Actualizar Perfil">
                                    <i class="mdi mdi-lead-pencil"></i>
                                </button>
                            </a>
                            <a href=" javascript:void(0)">
                                <button type="button" class="btn btn-primary btn-sm btn-rounded waves-effect waves-light mb-2 mb-md-0" title="Desactivar Perfil" data-id="'.$row->id.'" id="delete-patient">
