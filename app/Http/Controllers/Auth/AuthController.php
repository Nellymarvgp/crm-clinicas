...
class AuthController extends Controller
{
    ...
    public function register(Request $request)
    {
        ...
        try {
            ...
            // Ensure mobile is set, even if null
            $dataToRegister = array_merge($validatedData, ['mobile' => $request->input('mobile', null)]);
            //Create a new user
            $user = Sentinel::registerAndActivate($dataToRegister);
