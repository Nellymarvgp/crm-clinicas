                        ...
                        <form id="addtime" action="@if ($doctor && $doctor_info) {{ url('doctor/' . $doctor->id) }} @else {{ route('doctor.store') }} @endif" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                                <label class="form-label">{{ __('Especialidades') }}<span
                                                    class="text-danger">*</span></label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                            <label class="form-label">{{ __('Duracion de cita (minutos) ') }}<span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-12">
                                            <div class='repeater mb-4'>
                                                <div data-repeater-list="TimeSlot" class="mb-3">
                                                        ...
                                                        <label>{{ __('Rangos de horario disponibles ') }}<span
                                                            class="text-danger">*</span></label>
                                                        ...
                                                        <div class="col-md-5 col-6">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="time" name="from"
                                                                    ...
                                                                    placeholder="{{ __('Hora inicial') }}" id="time_from" />
                                                                @error('TimeSlot.*')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                                <label class="form-label">{{ __('% Pago Doctor ') }}<span
                                                    class="text-danger">*</span></label>
                                            <input type="number" step="0.01" min="0" max="100"
                                                ...
                                                value="@if ($doctor && $doctor_info){{ $doctor_info->doctor_payment_percentage }}@elseif(old('doctor_payment_percentage')){{ old('doctor_payment_percentage') }}@else{{ 0 }}@endif"
                                                placeholder="{{ __('Ingrese porcentaje de pago') }}">
