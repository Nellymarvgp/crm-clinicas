    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li class="menu-title" key="t-menu">{{ __('Gestión Odontológica') }}</li>
                @if ($role == 'admin')
                    <li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="true">
                            ...
                            <li><a href="{{ url('complete-appointment') }}">{{ __('translation.complete-appointment') }}</a></li>
                            <li><a href="{{ url('cancel-appointment') }}">{{ __('translation.cancelled') }} {{ __('translation.appointments') }}</a></li>
                        </ul>
                    </li>
                    <li class="menu-title" key="t-menu">{{ __('Transacciones') }}</li>
                    <li>
                    ...
                    <li class="menu-title" key="t-menu">{{ __('Configuración') }}</li>
                    <li>
                ...
                @elseif ($role == 'doctor')
                    ...
                    <li class="menu-title" key="t-menu">{{ __('Facturación') }}</li>
