            ...
            <div class="card-body pt-0">
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <p class="text-muted mb-0 text-truncate">{{ __('translation.patients') }}</p>
                    </div>
                    <div class="col-sm-8">
                        <div class="pt-4">
                            <div class="row">
                            ...
                            <div class="row mt-4">
                                <div class="col-12">
                                    <a href="{{ url('profile-edit') }}" class="btn btn-primary waves-effect waves-light btn-sm">{{ __('translation.edit-profile') }}
