    ...
    <div class="col-xl-4">
            ...
            <div class="card-body pt-0">
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <p class="text-muted mb-0 text-truncate">{{ __('translation.accountant') }}</p>
                    </div>
                    <div class="col-sm-8">
                        <div class="pt-4">
                            <div class="row">
                                <div class="col-12">
                                    <h5 class="font-size-12">{{ __('translation.last-login') }}:</h5>
                            ...
                            <div class="row mt-4">
                                <div class="col-12">
                                    <a href="{{ url('profile-edit') }}"
                                        class="btn btn-primary waves-effect waves-light btn-sm">{{ __('translation.edit-profile') }}
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <p class="text-muted">{{ __('translation.this-month') }}</p>
                        ...
                        <p class="text-muted"><span class="@if ($data['monthly_diff'] > 0) text-success @else text-danger @endif me-2"> {{ $data['monthly_diff'] }}% <i class="mdi @if ($data['monthly_diff'] > 0) mdi-arrow-up @else mdi-arrow-down @endif"></i> </span>
                            {{ __('translation.from-previous-month') }}</p>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-muted fw-medium">{{ __('translation.total-invoices') }}</p>
            ...
            <div class="col-md-4">
                <div class="card mini-stats-wid">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-muted fw-medium">{{ __('translation.unpaid-invoices') }}</p>
            ...
            <div class="col-md-4">
                <div class="card mini-stats-wid">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-muted fw-medium">{{ __('translation.total-income') }}</p>
            ...
            <div class="col-md-4">
                <div class="card mini-stats-wid">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-muted fw-medium">{{ __('translation.total-due') }}</p>
