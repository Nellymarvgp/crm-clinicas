                    ...
                    <div class="row">
                        ...
                        <div class="col-3 pull-right">
                            <address>
                                ...
                                <strong>{{ __('Appointment date: ') }}</strong>{{ optional($invoice_detail->appointment)->appointment_date . ' ' . (optional(optional($invoice_detail->appointment)->timeSlot)->from ? optional(optional($invoice_detail->appointment)->timeSlot)->from . ' to ' . optional(optional($invoice_detail->appointment)->timeSlot)->to : 'Sin horario') }}
                            </address>
                        </div>
                    </div>
                    <div class="py-2 mt-3">
