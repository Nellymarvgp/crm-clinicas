                            ...
                            <tbody>
                                ...
                                @foreach ($prescriptions_details as $item)
                                        <tr>
                                            ...
                                            <td>{{ optional(optional($item->appointment)->timeSlot)->from ? optional(optional($item->appointment)->timeSlot)->from . ' to ' . optional(optional($item->appointment)->timeSlot)->to : 'Sin horario' }}
                                            </td>
                                            <td>
