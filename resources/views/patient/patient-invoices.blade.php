                            ...
                            <tbody>
                                ...
                                @foreach ($invoices as $invoice)
                                    <tr>
                                        ...
                                        <td>{{ optional(optional($invoice->appointment)->timeSlot)->from ? optional(optional($invoice->appointment)->timeSlot)->from . ' to ' . optional(optional($invoice->appointment)->timeSlot)->to : 'Sin horario' }}
                                        </td>
