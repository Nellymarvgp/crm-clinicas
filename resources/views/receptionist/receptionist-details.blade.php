...
@section('title')
    @if ($receptionist)
        {{ __('Actualizar Datos del Recepcionista') }}
    @else
        {{ __('Agregar Nuevo Recepcionista') }}
    @endif
@endsection
@section('css')
                ...
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ url('receptionist') }}">{{ __('Recepcionistas') }}</a>
                            </li>
            ...
            <div class="col-12">
                ...
                @else
                    <a href="{{ url('receptionist') }}">
                        <button type="button" class="btn btn-primary waves-effect waves-light mb-4">
                            <i
                                class="bx bx-arrow-back font-size-16 align-middle me-2"></i>{{ __('Volver a la Lista de Recepcionistas') }}
                        </button>
                    </a>
                @endif
            </div>
                        ...
                        <form action="@if ($receptionist) {{ url('receptionist/' . $receptionist->id) }} @else {{ route('receptionist.store') }} @endif" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            <label class="form-label">{{ __('Odontólogo ') }}<span
                                                    class="text-danger">*</span></label>
