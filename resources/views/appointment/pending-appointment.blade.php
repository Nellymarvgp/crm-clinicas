...
@section('title') {{ __('Lista de Citas Pendientes') }} @endsection
    @section('content')
        <!-- start page title -->
        @component('components.breadcrumb')
            @slot('title') Lista de Citas Pendientes @endslot
                            ...
                            <div class="tab-pane active" id="PendingAppointmentList" role="tabpanel">
                                ...
                                <div class="col-md-12 text-center mt-3">
                                    <div class="d-flex justify-content-start">
                                        Mostrando {{ $pending_appointment->firstItem() }} a
                                        {{ $pending_appointment->lastItem() }} de {{ $pending_appointment->total() }}
                                        registros
                                    </div>
