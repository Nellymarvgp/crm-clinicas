...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <blockquote>{{ __('Agendar Cita') }}</blockquote>
                    <form action="{{ url('appointment-store') }}" id="" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <select class="form-control select2 @error('appointment_for') is-invalid @enderror"
                                        ...
                                        <option hidden selected disabled>{{ __('Seleccione') }}</option>
                        ...
                        @if ($role != 'doctor')
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    <label class="control-label">{{ __('Odontólogo ') }}<span
                                            class="text-danger">*</span></label>
                                    <select
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <label class="control-label">{{ __('Fecha ') }}<span class="text-danger">*</span></label>
