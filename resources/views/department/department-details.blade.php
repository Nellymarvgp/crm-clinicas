...
@section('title')
    @if ($department)
        {{ __('Actualizar Datos de la Especialidad') }}
    @else
        ...
        <div class="col-12">
            ...
            @else
                <a href="{{ url('department') }}">
                    <button type="button" class="btn btn-primary waves-effect waves-light mb-4">
                        <i class="bx bx-arrow-back font-size-16 align-middle me-2"></i>{{ __('Volver a la Lista de Especialidades') }}
                    </button>
                </a>
            @endif
        </div>
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        <label for="department-name" class="form-label">{{ __('Nombre de la Especialidad ') }}<span
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            ...
                                            placeholder="{{ __('Ingrese el nombre de la especialidad') }}">
                                        @error('name')
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <label for="department-description"
                                            class="form-label">{{ __('Descripción ') }}<span
                                                class="text-danger">*</span></label>
                                        <input type="text"
                                            ...
                                            placeholder="{{ __('Máximo 250 caracteres') }}">
                                        @error('description')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
