...
<body>
    ...
    <div class="landing-page">
            ...
            <nav class="navbar navbar-expand-lg bg-body-tertiary fixed-top navbar-custom sticky sticky-light"
                ...
                <div class="container">
                    <a class="navbar-brand logo d-flex align-items-center" href="#home" aria-label="CORE">
                        <img src="{{ URL::asset('build/images/logo.jpg') }}" alt="Logo CORE" class="core-logo">
                    </a>
                    ...
                    <div class="row">
                            ...
                            <div class="blockLeft">
                                <div class="content">
                                    ...
                                    <div class="hero-btn mt-4">
                                        <a href="{{ url('login') }}" class="btn btn-primary">Agendar cita</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-xs-12">
                            <div class="blockRight">
                                <div class="content">
                                    <img src="{{ URL::asset('build/images/fondo-bg.jpg') }}" alt="" class="image-bg">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <!-- commitment-section start  -->
            <section class="CuartoBloque" id="commitment" style="background: url({{ URL::asset('build/images/fondo-od.jpg') }}) no-repeat center center/cover;">
                <div class="containers">
                    <div class="content">
                        <div class="row">
                            <div class="col-md-12">
                                <img src="{{ URL::asset('build/images/servicio1.png') }}" alt="">
        ...
        @if ($data['Contact'] == 0)
            <!-- cta-section start  -->
            <section class="CuartoBloque" id="contact" style="background: url({{ URL::asset('build/images/fondo-consulta.jpg') }}) no-repeat center center/cover;">
                <div class="containers">
                    <div class="content">
                        <div class="row">
                            <div class="col-md-6 col-xs-12">
                ...
                <div class="row justify-content-between g-2">
                    <div class="col-lg-4">
                        <a class="brand-logo d-flex align-items-center" href="#home" aria-label="CORE">
                            <img src="{{ URL::asset('build/images/logo.jpg') }}" alt="Logo CORE" class="core-logo core-logo-footer">
                        </a>
