...
@section('title') Editar Configuración de Llamada @endsection
...
@section('content')
    @component('components.breadcrumb')
        @slot('title') Editar Configuración de Llamada @endslot
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('setting-call.update', $callSetting->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('agent_name') is-invalid @enderror" id="agent_name" name="agent_name" value="{{ old('agent_name', $callSetting->agent_name) }}" required>
                                    @error('agent_name')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('agent_id') is-invalid @enderror" id="agent_id" name="agent_id" value="{{ old('agent_id', $callSetting->agent_id) }}" required>
                                    @error('agent_id')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" class="form-control @error('call_url') is-invalid @enderror" id="call_url" name="call_url" value="{{ old('call_url', $callSetting->call_url) }}" placeholder="https://ejemplo.com/api/call" required>
                            @error('call_url')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <div id="parameters-container">
                                @if(old('parameters'))
                                    ...
                                    @endforeach
                                @elseif($callSetting->parameters)
                                    @foreach($callSetting->parameters as $key => $value)
                                        <div class="row param-row mb-2">
                                            <div class="col-md-5">
                                                <input type="text" class="form-control" name="parameters[{{ $loop->index }}][key]" placeholder="Clave" value="{{ $key }}">
                                            </div>
                                            <div class="col-md-5">
                                                <input type="text" class="form-control" name="parameters[{{ $loop->index }}][value]" placeholder="Valor" value="{{ $value }}">
                                            </div>
                                            <div class="col-md-2">
                                                <i class="mdi mdi-close-circle remove-param-btn align-middle" style="font-size: 24px;"></i>
                                            </div>
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="is_active" name="is_active" {{ $callSetting->is_active ? 'checked' : '' }}>
