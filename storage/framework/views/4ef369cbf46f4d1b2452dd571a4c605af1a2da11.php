                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="avatar-md profile-user-wid mb-4">
                                    <img src="<?php if($receptionist->profile_photo != ''): ?><?php echo e(URL::asset('storage/images/users/' . $receptionist->profile_photo)); ?><?php else: ?><?php echo e(URL::asset('build/images/users/noImage.png')); ?><?php endif; ?>" alt="<?php echo e($receptionist->fisrt_name); ?>"
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <?php $__currentLoopData = $doctor_user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $show): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <span
                                                    class="badge bg-info font-size-14 my-2"><?php echo e($show->first_name . ' ' . $show->last_name); ?></span>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\appyweb\crm_clinicas\crm-clinicas\resources\views\receptionist\receptionist-profile-view.blade.php ENDPATH**/ ?>