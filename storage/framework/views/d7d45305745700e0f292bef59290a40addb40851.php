                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            <label class="form-label"><?php echo e(__('Cédula')); ?><span class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>" name="cedula" value="<?php echo e(old('cedula', $patient->cedula ?? '')); ?>" placeholder="<?php echo e(__('Ingrese la cédula')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label"><?php echo e(__('¿Qué medicamentos utiliza?')); ?></label>
                                            <textarea class="form-control <?php $__errorArgs = ['medications_list'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                placeholder="<?php echo e(__('Indique el nombre, dosis y frecuencia de cada medicamento')); ?>"><?php if($medical_info): ?><?php echo e(old('medications_list', $medical_info->medications_list)); ?><?php else: ?><?php echo e(old('medications_list')); ?><?php endif; ?></textarea>
