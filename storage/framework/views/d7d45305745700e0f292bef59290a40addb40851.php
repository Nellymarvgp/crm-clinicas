    ...
    <?php $__env->startSection('content'); ?>
            ...
            <div class="col-12">
                ...
                <?php else: ?>
                    <a href="<?php echo e(url('patient')); ?>">
                        <button type="button" class="btn btn-primary waves-effect waves-light mb-4">
                            <i
                                class="bx bx-arrow-back font-size-16 align-middle me-2"></i><?php echo e(__('Back to Patient List')); ?>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <blockquote class="blockquote"><?php echo e(__('Basic Information')); ?></blockquote>
