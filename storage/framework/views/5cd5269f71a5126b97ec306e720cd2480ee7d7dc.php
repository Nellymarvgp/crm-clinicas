<?php $__env->startSection('title'); ?>
    <?php if($receptionist): ?>
        <?php echo e(__('Actualizar Datos del Recepcionista')); ?>

    <?php else: ?>
        <?php echo e(__('Agregar Nuevo Recepcionista')); ?>
                ...
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo e(url('receptionist')); ?>"><?php echo e(__('Recepcionistas')); ?></a>
                            </li>
            ...
            <div class="col-12">
                ...
                <?php else: ?>
                    <a href="<?php echo e(url('receptionist')); ?>">
                        <button type="button" class="btn btn-primary waves-effect waves-light mb-4">
                            <i
                                class="bx bx-arrow-back font-size-16 align-middle me-2"></i><?php echo e(__('Volver a la Lista de Recepcionistas')); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            <label class="form-label"><?php echo e(__('Odontólogo ')); ?><span
                                                    class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                <?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e(@$item->doctor->id); ?>" <?php if(old('doctor') == @$item->doctor->id): ?> selected <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>"
                                                src="<?php if($receptionist && $receptionist->profile_photo != null): ?><?php echo e(URL::asset('storage/images/users/' . $receptionist->profile_photo)); ?><?php else: ?><?php echo e(URL::asset('build/images/users/noImage.png')); ?><?php endif; ?>" id="profile_display" onclick="triggerClick()"
                                                data-bs-toggle="tooltip" data-placement="top"
                                                title="Haga clic para subir la foto de perfil" />
                                            <input type="file"
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\appyweb\crm_clinicas\crm-clinicas\resources\views\receptionist\receptionist-details.blade.php ENDPATH**/ ?>