                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <address>
                                    ...
                                    <?php echo e(optional($user_details->appointment)->appointment_date . ' ' . (optional(optional($user_details->appointment)->timeSlot)->from ? optional(optional($user_details->appointment)->timeSlot)->from . ' to ' . optional(optional($user_details->appointment)->timeSlot)->to : 'Sin horario')); ?>
