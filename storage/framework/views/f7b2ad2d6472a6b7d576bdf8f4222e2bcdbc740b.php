<?php $__env->startSection('title'); ?> <?php echo e(__('List of Prescription')); ?> <?php $__env->stopSection(); ?>
    <?php $__env->startSection('content'); ?>
        ...
        <!-- end page title -->
        <?php if(count($prescriptions_details) == 0): ?>
                                ...
                                <?php $__currentLoopData = $prescriptions_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <?php if($role == 'receptionist'): ?>
                                                ...
                                                <td><?php echo e(@$item->doctor->user->first_name . ' ' . @$item->doctor->user->first_name); ?>
                                            ...
                                            <?php elseif($role == 'patient'): ?>
                                                <td><?php echo e(@$item->doctor->user->first_name); ?>

                                                    <?php echo e(@$item->doctor->user->last_name); ?></td>
                                            <?php else: ?>
                                                <td><?php echo e($item->patient->first_name); ?>
                                            ...
                                            <td><?php echo e(optional(optional($item->appointment)->timeSlot)->from ? optional(optional($item->appointment)->timeSlot)->from . ' to ' . optional(optional($item->appointment)->timeSlot)->to : 'Sin horario'); ?>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\appyweb\crm_clinicas\crm-clinicas\resources\views\patient\patient-prescriptions.blade.php ENDPATH**/ ?>