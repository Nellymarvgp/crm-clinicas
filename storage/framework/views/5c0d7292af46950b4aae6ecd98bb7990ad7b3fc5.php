                        ...
                        <div class="row">
                            ...
                            <div class="col-3 pull-right">
                                <address>
                                    ...
                                    <strong><?php echo e(__('Appointment date: ')); ?></strong><?php echo e($invoice->appointment->appointment_date . ' ' . $invoice->appointment->timeSlot->from . ' to ' . $invoice->appointment->timeSlot->to); ?>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\appyweb\crm_clinicas\crm-clinicas\resources\views\invoice\view-invoice.blade.php ENDPATH**/ ?>