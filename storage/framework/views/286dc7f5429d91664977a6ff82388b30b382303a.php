<?php $__env->startSection('title'); ?> <?php echo e(__('Lista de Transacciones')); ?> <?php $__env->stopSection(); ?>
    <?php $__env->startSection('content'); ?>
        <!-- start page title -->
        <?php $__env->startComponent('components.breadcrumb'); ?>
            <?php $__env->slot('title'); ?> Lista de Transacciones <?php $__env->endSlot(); ?>
            <?php $__env->slot('li_1'); ?> Panel <?php $__env->endSlot(); ?>
            <?php $__env->slot('li_2'); ?> Transacciones <?php $__env->endSlot(); ?>
                    ...
                    <div class="card-body">
                        <table class="table table-bordered dt-responsive nowrap "
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th><?php echo e(__('Nombre de facturación')); ?></th>
                                    <th><?php echo e(__('ID de orden')); ?></th>
                                    <th><?php echo e(__('Nro. de transacción')); ?></th>
                                    <th><?php echo e(__('Monto ($)')); ?></th>
                                    <th><?php echo e(__('Método de pago')); ?></th>
                        ...
                        <div class="col-md-12 text-center mt-3">
                            <div class="d-flex justify-content-start">
                                Mostrando <?php echo e($transaction->firstItem()); ?> a <?php echo e($transaction->lastItem()); ?> de
                                <?php echo e($transaction->total()); ?> registros
                            </div>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\appyweb\crm_clinicas\crm-clinicas\resources\views/admin/transaction.blade.php ENDPATH**/ ?>