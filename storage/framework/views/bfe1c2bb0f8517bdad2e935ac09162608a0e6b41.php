<?php $__env->startSection('title'); ?>
    <?php echo e(__('Payment Gateway Key')); ?>
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('payment-key.store')); ?>" method="post">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input name="razorpay_key" value="<?php echo e($razorpay != null ? $razorpay->key : ''); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input name="razorpay_secret" value="<?php echo e($razorpay != null ? $razorpay->secret : ''); ?>"
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('payment-key.store')); ?>" method="post">
                            ...
                            <div class="col-12 mb-3">
                                <label class="form-label" for="payment_key"> Key <span class="text-danger">*</span></label>
                                <input name="stripe_key" value="<?php echo e($stripe != null ? $stripe->key : ''); ?>" class="form-control"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-12 mb-3">
                                <label class="form-label" for="payment_key"> Secret <span class="text-danger">*</span></label>
                                <input name="stripe_secrets" value="<?php echo e($stripe != null ? $stripe->secret : ''); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="d-flex">
                                ...
                                <?php if($stripe): ?>
                                    <div class="">
                                        <a href="javascript:void(0)" class="btn btn-danger" data-id="<?php echo e($stripe->id); ?>"
                                            id="delete-api">
                                            <?php echo e(__('Delete')); ?>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\appyweb\crm_clinicas\crm-clinicas\resources\views/admin/payment-key.blade.php ENDPATH**/ ?>