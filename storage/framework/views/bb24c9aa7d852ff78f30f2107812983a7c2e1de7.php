            ...
            <div class="card-body pt-0">
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <p class="text-muted mb-0 text-truncate"><?php echo e(__('translation.receptionist')); ?></p>
                    </div>
                    <div class="col-sm-8">
                        <div class="pt-4">
                            <div class="row">
                            ...
                            <div class="row mt-4">
                                <div class="col-12">
                                    <a href="<?php echo e(url('profile-edit')); ?>"
                                        class="btn btn-primary waves-effect waves-light btn-sm"><?php echo e(__('translation.edit-profile')); ?>
            ...
            <div class="col-md-4">
                <div class="card mini-stats-wid">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-muted fw-medium"><?php echo e(__('translation.doctors')); ?></p>
                                <a href="<?php echo e(url('/doctor')); ?>" class="mb-0 fw-medium font-size-24">
            ...
            <div class="col-md-4">
                <div class="card mini-stats-wid">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-muted fw-medium"><?php echo e(__('translation.patients')); ?></p>
                                <a href="<?php echo e(url('/patient')); ?>" class="mb-0 fw-medium font-size-24">
            ...
            <div class="col-md-4">
                <div class="card mini-stats-wid">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-muted fw-medium"><?php echo e(__("translation.today's-appointments")); ?>

                                </p>
                                <a href="<?php echo e(url('/today-appointment')); ?>" class="mb-0 fw-medium font-size-24">
            ...
            <div class="col-md-4">
                <div class="card mini-stats-wid">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-muted fw-medium"><?php echo e(__('translation.tomorrow-appointments')); ?>
            ...
            <div class="col-md-4">
                <div class="card mini-stats-wid">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-muted fw-medium"><?php echo e(__('translation.upcoming-appointments')); ?>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $appointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e(@$item->doctor->user->first_name . ' ' . @$item->doctor->user->last_name); ?></td>
...
<!-- end row -->
<?php /**PATH C:\wamp64\www\appyweb\crm_clinicas\crm-clinicas\resources\views\layouts\receptionist-dashboard.blade.php ENDPATH**/ ?>