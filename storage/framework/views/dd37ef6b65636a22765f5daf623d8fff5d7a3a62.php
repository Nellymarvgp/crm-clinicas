<?php $__env->startSection('title'); ?>
    <?php if($department): ?>
        <?php echo e(__('Actualizar Datos de la Especialidad')); ?>

    <?php else: ?>
        <?php echo e(__('Agregar Nueva Especialidad')); ?>
        ...
        <div class="col-12">
            ...
            <?php else: ?>
                <a href="<?php echo e(url('department')); ?>">
                    <button type="button" class="btn btn-primary waves-effect waves-light mb-4">
                        <i class="bx bx-arrow-back font-size-16 align-middle me-2"></i><?php echo e(__('Volver a la Lista de Especialidades')); ?>
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        <label for="department-name" class="form-label"><?php echo e(__('Nombre de la Especialidad ')); ?><span
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            placeholder="<?php echo e(__('Ingrese el nombre de la especialidad')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <label for="department-description"
                                            class="form-label"><?php echo e(__('Descripción ')); ?><span
                                                class="text-danger">*</span></label>
                                        <input type="text"
...
unset($__errorArgs, $__bag); ?>" tabindex="1"
                                            ...
                                            placeholder="<?php echo e(__('Máximo 250 caracteres')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <label for="department-image" class="form-label"><?php echo e(__('Imagen de la especialidad')); ?></label>
                                        <input type="file"
...
unset($__errorArgs, $__bag); ?>
                                        <?php if($department && $department->image): ?>
                                            <div class="mt-2">
                                                <img src="<?php echo e(URL::asset('build/images/nuevas/' . $department->image)); ?>" alt="<?php echo e($department->name); ?>" style="max-height: 90px;">
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                </div>
