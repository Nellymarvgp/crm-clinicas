                    ...
                    <div class="card overflow-hidden">
                            ...
                            <div class="row">
                                <div class="col-7">
                                    <div class="text-primary p-4">
                                        <h5 class="text-primary"><?php echo e(AppSetting('title')); ?> - Sistema de gestión odontológica</h5>
                                        <p>Aquí tienes las credenciales de acceso para <?php echo e(AppSetting('title')); ?>.</p>
                                    </div>
                                </div>
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="p-2">
                                ...
                                <p><b>Usuario:</b> <?php echo e($user->email); ?></p>
                                <p><b>Contraseña:</b> <?php echo e(config('app.DEFAULT_PASSWORD')); ?></p>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\appyweb\crm_clinicas\crm-clinicas\resources\views\emails\WelcomeEmail.blade.php ENDPATH**/ ?>