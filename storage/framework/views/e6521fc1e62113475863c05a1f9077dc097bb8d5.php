<?php $__env->startSection('title'); ?> <?php echo e(__('Citas Canceladas')); ?> <?php $__env->stopSection(); ?>
    <?php $__env->startSection('content'); ?>
        <!-- start page title -->
        <?php $__env->startComponent('components.breadcrumb'); ?>
            <?php $__env->slot('title'); ?> Citas Canceladas <?php $__env->endSlot(); ?>
                            ...
                            <div class="tab-pane active" id="PendingAppointmentList" role="tabpanel">
                                        ...
                                        <tbody>
                                            ...
                                            <?php $__currentLoopData = $Cancel_appointment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e(trim((optional(optional($item->doctor)->user)->first_name ?? '') . ' ' . (optional(optional($item->doctor)->user)->last_name ?? '')) ?: 'Sin doctor asignado'); ?></td>
                                ...
                                <div class="col-md-12 text-center mt-3">
                                    <div class="d-flex justify-content-start">
                                        Mostrando <?php echo e($Cancel_appointment->firstItem()); ?> a
                                        <?php echo e($Cancel_appointment->lastItem()); ?> de <?php echo e($Cancel_appointment->total()); ?>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\appyweb\crm_clinicas\crm-clinicas\resources\views\appointment\cancel-appointment.blade.php ENDPATH**/ ?>