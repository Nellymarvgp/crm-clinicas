            ...
            <div class="navbar-brand-box">
                <a href="<?php echo e(url('/dashboard')); ?>" class="logo logo-dark">
                    <span class="logo-lg d-flex align-items-center gap-2">
                        <i class="fas fa-tooth text-success font-size-20"></i>
                        <span class="logo-text text-success fw-semibold">CORE</span>
                    </span>
                    <span class="logo-sm d-flex align-items-center">
                        <i class="fas fa-tooth text-success font-size-18"></i>
                    </span>
                </a>
