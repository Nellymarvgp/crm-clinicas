            ...
            <div class="col-12">
                <?php if($doctor && $doctor_info): ?>
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(url('doctor/' . $doctor->id)); ?>">
                            <button type="button" class="btn btn-primary waves-effect waves-light mb-4">
                                <i
                                    class="bx bx-arrow-back font-size-16 align-middle me-2"></i><?php echo e(__('Back to Profile')); ?>
                ...
                <?php else: ?>
                    <a href="<?php echo e(url('doctor')); ?> ">
                        <button type="button" class="btn btn-primary waves-effect waves-light mb-4">
                            <i
                                class="bx bx-arrow-back font-size-16 align-middle me-2"></i><?php echo e(__('Back to Doctor List')); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            <label class="form-label"><?php echo e(__('Department')); ?><span
                                                    class="text-danger">*</span></label>
                                            <select class="form-control select2 <?php $__errorArgs = ['department'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            <label class="form-label"><?php echo e(__('Experience ')); ?><span
                                                    class="text-danger">*</span></label>
                                            <input type="text"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            <label class="form-label d-block"><?php echo e(__("Doctor available days ")); ?><span
                                                    class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            <label class="form-label"><?php echo e(__('Degree ')); ?><span
                                                    class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            <label class="form-label"><?php echo e(__('Fees ')); ?><span
                                                    class="text-danger">*</span></label>
