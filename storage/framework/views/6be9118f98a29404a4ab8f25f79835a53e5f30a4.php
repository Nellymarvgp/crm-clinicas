                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="avatar-md profile-user-wid mb-4">
                                    <img src="<?php if($doctor->profile_photo != ''): ?><?php echo e(URL::asset('storage/images/users/' . $doctor->profile_photo)); ?><?php else: ?><?php echo e(URL::asset('build/images/users/noImage.png')); ?><?php endif; ?>" alt="<?php echo e($doctor->first_name); ?>"
                                ...
                                <p class="badge bg-success text-white mb-0 text-truncate">
                                    <?php echo e($doctor_info->departments->pluck('name')->implode(' / ') ?: ($doctor_info->department->name ?? '')); ?>
                        ...
                        <div class="table-responsive">
                            <table class="table mb-0">
                                <tbody>
                                    ...
                                    <tr>
                                        <th scope="row"><?php echo e(__('Specialties:')); ?></th>
                                        <td><?php echo e($doctor_info->departments->pluck('name')->implode(' / ') ?: ($doctor_info->department->name ?? '')); ?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <th scope="row"><?php echo e(__('Doctor Payment Percentage:')); ?></th>
                                        <td><?php echo e(number_format((float) $doctor_info->doctor_payment_percentage, 2)); ?>%</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <?php if($availableDay): ?>
                            <?php if($availableDay->sun == 1): ?>
                                <span class="badge bg-info font-size-15 my-2"><?php echo e(__('Sunday')); ?></span>
                            <?php endif; ?>
                            <?php if($availableDay->mon == 1): ?>
                                <span class="badge bg-info font-size-15 my-2"><?php echo e(__('Monday')); ?></span>
                            <?php endif; ?>
                            <?php if($availableDay->tue == 1): ?>
                                <span class="badge bg-info font-size-15 my-2"><?php echo e(__('Tuesday')); ?></span>
                            <?php endif; ?>
                            <?php if($availableDay->wen == 1): ?>
                                <span class="badge bg-info font-size-15 my-2"><?php echo e(__('Wednesday')); ?></span>
                            <?php endif; ?>
                            <?php if($availableDay->thu == 1): ?>
                                <span class="badge bg-info font-size-15 my-2"><?php echo e(__('Thursday')); ?></span>
                            <?php endif; ?>
                            <?php if($availableDay->fri == 1): ?>
                                <span class="badge bg-info font-size-15 my-2"><?php echo e(__('Friday')); ?></span>
                            <?php endif; ?>
                            <?php if($availableDay->sat == 1): ?>
                                <span class="badge bg-info font-size-15 my-2"><?php echo e(__('Saturday')); ?></span>
                            <?php endif; ?>
                        <?php endif; ?>
                        <hr>
                        <p>Available Time</p>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\appyweb\crm_clinicas\crm-clinicas\resources\views\doctor\doctor-profile.blade.php ENDPATH**/ ?>