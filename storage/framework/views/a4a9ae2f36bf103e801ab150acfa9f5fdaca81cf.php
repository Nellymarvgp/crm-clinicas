    ...
    <?php $__env->startSection('content'); ?>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form action="<?php echo e(url('time-update/' . $doctor->id)); ?>" method="post"
                            enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="id" value="<?php echo e($doctor->id); ?>" id="form_id" />
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <?php for($i = 1; $i <= 60; $i++): ?>
                                            <option value="<?php echo e($i); ?>"
                                                <?php echo e($i == $doctor_info->slot_time ? 'selected' : ''); ?>>
                                                <?php echo e($i); ?>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\appyweb\crm_clinicas\crm-clinicas\resources\views/doctor/doctor_time_edit.blade.php ENDPATH**/ ?>