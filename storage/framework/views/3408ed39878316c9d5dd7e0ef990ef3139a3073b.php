...
<div class="row">
                            ...
                            <div class="row mt-4">
                                <div class="col-12">
                                    ...
                                    <a href="<?php echo e(url('time-edit/' . $user->id)); ?>"
                                        class="btn btn-primary waves-effect waves-light btn-sm"><?php echo e(__('translation.edit-time-slot')); ?>
    ...
    <div class="col-xl-8">
            ...
            <div class="col-md-4">
                <div class="card mini-stats-wid">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-muted fw-medium"><?php echo e(__('translation.today-earning')); ?></p>
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4"><?php echo e(__('translation.monthly-appointments')); ?></h4>
...
<!-- end row -->
<?php /**PATH C:\wamp64\www\appyweb\crm_clinicas\crm-clinicas\resources\views\layouts\doctor-dashboard.blade.php ENDPATH**/ ?>