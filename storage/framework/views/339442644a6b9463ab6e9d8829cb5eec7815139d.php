<?php $__env->startSection('title'); ?>
    <?php echo e(__('List of Accountants')); ?>
                    ...
                    <?php if($role == 'admin'): ?>
                        <a href=" <?php echo e(route('accountant.create')); ?> ">
                            <button type="button" class="btn btn-primary waves-effect waves-light mb-4">
                                <i class="bx bx-plus font-size-16 align-middle me-2"></i> <?php echo e(__('New Accountant')); ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#accountantList').DataTable({
                ...
                ajax: "<?php echo e(route('accountant.index')); ?>",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\appyweb\crm_clinicas\crm-clinicas\resources\views\accountant\accountants.blade.php ENDPATH**/ ?>