<?php $__env->startSection('title'); ?>
    <?php echo e(__('List of Prescription')); ?>
...
<?php $__env->startSection('content'); ?>
    <div id="pageloader">
        <img src="<?php echo e(URL::asset('build/images/loader.gif')); ?>" alt="processing..." />
    </div>
    <!-- start page title -->
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $prescriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prescription): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <?php elseif($role == 'patient'): ?>
                                        <td><?php echo e(@$prescription->doctor->user->first_name); ?>

                                            <?php echo e(@$prescription->doctor->user->last_name); ?></td>
                                    <?php else: ?>
                                        <td><?php echo e($prescription->patient->first_name); ?>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\appyweb\crm_clinicas\crm-clinicas\resources\views\prescription\prescriptions.blade.php ENDPATH**/ ?>