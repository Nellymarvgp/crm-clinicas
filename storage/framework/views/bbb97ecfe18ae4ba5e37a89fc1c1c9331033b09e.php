<?php $__env->startSection('title'); ?> <?php echo e(__('Citas de Hoy')); ?> <?php $__env->stopSection(); ?>
    <?php $__env->startSection('content'); ?>
        <!-- start page title -->
        <?php $__env->startComponent('components.breadcrumb'); ?>
            <?php $__env->slot('title'); ?> Citas de Hoy <?php $__env->endSlot(); ?>
                            ...
                            <div class="tab-pane active" id="PendingAppointmentList" role="tabpanel">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if($item->status == 0): ?>
                                                            <?php if($role == 'doctor' || $role == 'receptionist' || $role == 'admin'): ?>
                                                        ...
                                                        <?php elseif($item->status == 2): ?>
                                                            <button type="button" class="btn btn-success complete" data-id="<?php echo e($item->id); ?>">Completar</button>
                                                            <button type="button" class="btn btn-danger cancel" data-id="<?php echo e($item->id); ?>">Cancelar</button>
                                                        <?php endif; ?>
                                                    </td>
                                                </tr>
                                ...
                                <div class="col-md-12 text-center mt-3">
                                    <div class="d-flex justify-content-start">
                                        Mostrando <?php echo e($Today_appointment->firstItem()); ?> a
                                        <?php echo e($Today_appointment->lastItem()); ?> de <?php echo e($Today_appointment->total()); ?>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\appyweb\crm_clinicas\crm-clinicas\resources\views\appointment\today-appointment.blade.php ENDPATH**/ ?>