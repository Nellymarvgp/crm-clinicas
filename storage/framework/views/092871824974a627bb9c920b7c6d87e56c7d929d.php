                ...
                <div class="card">
                    <div class="card-body">
                        <div class="invoice-title">
                            <h4 class="float-end font-size-16">Prescription #<?php echo e($prescription->id); ?></h4>
                            <div class="mb-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <address>
                                    <strong><?php echo e(__('Prescription Date: ')); ?></strong><?php echo e($prescription->created_at); ?><br>
                                    <strong><?php echo e(__('Appointment Date: ')); ?></strong><?php echo e($prescription->appointment->appointment_date . ' ' . $prescription->appointment->timeSlot->form . ' ' . $prescription->appointment->timeSlot->to); ?><br>
                                </address>
                            </div>
                        </div>
                        <div class="row">
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\appyweb\crm_clinicas\crm-clinicas\resources\views\prescription\view-prescription.blade.php ENDPATH**/ ?>