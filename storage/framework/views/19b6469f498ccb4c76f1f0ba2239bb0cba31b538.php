            ...
            <div class="row" id="doctorsGrid">
                <?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-lg-3 col-md-6 doctor-item" 
                         data-departments="<?php echo e(implode(',', $doctorDepartmentIds)); ?>">
                        <div class="doctor-card">
                            ...
                            <span class="specialty"><?php echo e(!empty($doctorSpecialties) ? implode(' / ', $doctorSpecialties) : 'Especialidad'); ?></span>
