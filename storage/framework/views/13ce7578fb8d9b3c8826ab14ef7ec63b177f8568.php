                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="avatar-md profile-user-wid mb-4">
                                    <img src="<?php if($accountant->profile_photo != ''): ?> <?php echo e(URL::asset('storage/images/users/' . $accountant->profile_photo)); ?><?php else: ?><?php echo e(URL::asset('build/images/users/noImage.png')); ?> <?php endif; ?>"
                                        alt="<?php echo e($accountant->fisrt_name); ?>" class="img-thumbnail rounded-circle">
                                </div>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\appyweb\crm_clinicas\crm-clinicas\resources\views\accountant\accountant-profile-view.blade.php ENDPATH**/ ?>