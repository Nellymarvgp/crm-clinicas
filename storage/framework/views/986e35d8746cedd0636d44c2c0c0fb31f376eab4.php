<?php $__env->startSection('title'); ?> <?php echo e(__('Lista de Citas Pendientes')); ?> <?php $__env->stopSection(); ?>
    <?php $__env->startSection('content'); ?>
        <!-- start page title -->
        <?php $__env->startComponent('components.breadcrumb'); ?>
            <?php $__env->slot('title'); ?> Lista de Citas Pendientes <?php $__env->endSlot(); ?>
                            ...
                            <div class="tab-pane active" id="PendingAppointmentList" role="tabpanel">
                                ...
                                <div class="col-md-12 text-center mt-3">
                                    <div class="d-flex justify-content-start">
                                        Mostrando <?php echo e($pending_appointment->firstItem()); ?> a
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\appyweb\crm_clinicas\crm-clinicas\resources\views/appointment/pending-appointment.blade.php ENDPATH**/ ?>