                    ...
                    <div class="row">
                        ...
                        <div class="col-3 pull-right">
                            <address>
                                ...
                                <strong><?php echo e(__('Appointment date: ')); ?></strong><?php echo e(optional($invoice_detail->appointment)->appointment_date . ' ' . (optional(optional($invoice_detail->appointment)->timeSlot)->from ? optional(optional($invoice_detail->appointment)->timeSlot)->from . ' to ' . optional(optional($invoice_detail->appointment)->timeSlot)->to : 'Sin horario')); ?>
