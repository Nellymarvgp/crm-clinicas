<?php $__env->startSection('title'); ?> Crear Configuración de Llamada <?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        <?php $__env->slot('title'); ?> Crear Configuración de Llamada <?php $__env->endSlot(); ?>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('setting-call.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?>" id="agent_name" name="agent_name" value="<?php echo e(old('agent_name')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="agent_id" name="agent_id" value="<?php echo e(old('agent_id')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="call_url" name="call_url" value="<?php echo e(old('call_url')); ?>" placeholder="https://ejemplo.com/api/call" required>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\appyweb\crm_clinicas\crm-clinicas\resources\views\call-setting\create.blade.php ENDPATH**/ ?>