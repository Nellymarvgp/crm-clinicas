...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                                <label class="form-label"><?php echo e(__('Departamento')); ?><span
                                                    class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                                <label class="form-label"><?php echo e(__('Honorarios ')); ?><span
                                                    class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                placeholder="<?php echo e(__('Ingrese los honorarios')); ?>">
