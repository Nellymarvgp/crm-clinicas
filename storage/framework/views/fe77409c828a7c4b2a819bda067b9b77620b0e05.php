...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <?php $__currentLoopData = $patients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($patient->id); ?>" <?php echo e($invoice_detail->patient->id == $patient->id?'selected':''); ?>>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <?php if($role == 'doctor' || $role == 'accountant'): ?>
                                    <div class="col-md-6 mb-3">
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            <option value="<?php echo e($item->id); ?>"
                                                <?php echo e($item->id == $invoice_detail->appointment->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    value="<?php echo e(@$invoice_detail->appointment->doctor->user->first_name .' '.@$invoice_detail->appointment->doctor->user->last_name); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label class="form-label"><?php echo e(__('Payment Mode ')); ?><span
                                            class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <option value="Cash Payement" <?php if($invoice_detail->payment_mode == 'Cash Payement'): ?> selected <?php endif; ?>><?php echo e(__('Cash Payment')); ?>

                                        </option>
                                        <option value="Cheque" <?php if($invoice_detail->payment_mode == 'Cheque'): ?> selected <?php endif; ?>><?php echo e(__('Cheque')); ?></option>
                                        <option value="Debit/Credit Card" <?php if($invoice_detail->payment_mode == 'Debit/Credit Card'): ?> selected <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label class="form-label"><?php echo e(__('Payment Status ')); ?><span
                                            class="text-danger">*</span></label>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\appyweb\crm_clinicas\crm-clinicas\resources\views\invoice\edit-invoice.blade.php ENDPATH**/ ?>